...
export default function LeadManageComponent({ lead }: LeadManageComponentProps)
{
    ...
    return <div className="h-14 bg-tertiary border-b-primary border-b-[1px] flex items-center gap-6 px-8 transition duration-300 hover:text-secondary hover:border-b-zinc-100 hover:bg-primary font-medium hover:cursor-pointer rounded">
        <Link 
        href={`/leads/${lead.id}`}
        className="flex flex-row gap-6 w-full items-center h-full">
